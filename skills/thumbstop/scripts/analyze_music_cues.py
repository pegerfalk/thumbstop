...
presets, and (2) an optional runtime "extended" beat-sync path for /thumbstop on
any track when Python + librosa are available (see references/audio.md ->
"Beat and cue sources"). When those deps are absent, /thumbstop falls back to
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Analyze a bundled music track and write /thumbstop cue presets."
    )
